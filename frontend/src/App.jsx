  ...
  return (
    <div className="poker-app">
      <div className="status-bar">
        <div className="money-item dealer">Dealer: <span>${gameData?.dealer_money ?? 2000}</span></div>
        <div className="money-item pot">Pot: <span className="pot-text">${gameData?.pot ?? 0}</span></div>
        <div className="money-item player">You: <span>${gameData?.player_money ?? 2000}</span></div>
      </div>
              ...
              <div className="bet-toggle-container">
                <div className="bet-slider-box">
                  ...
                  <input 
                    type="range" 
                    min="10" 
                    max={Math.min(gameData?.player_money || 2000, gameData?.dealer_money || 2000)} 
                    step="10"
                    value={betAmount}
